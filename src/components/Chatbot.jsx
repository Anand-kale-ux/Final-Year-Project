...
export default function Chatbot() {
  ...
  return (
    <>
      ...
      {/* Chat Window */}
      <div
        className={`fixed bottom-28 right-6 z-50 w-[370px] h-[550px] bg-[#0F172A]/95 backdrop-blur-xl border border-gray-700 rounded-3xl shadow-2xl overflow-hidden transition-all duration-500 ${
          open
